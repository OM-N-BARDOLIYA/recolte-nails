...
>
    <div 
        ...
        class="bg-white rounded-3xl border border-rose/20 shadow-2xl max-w-md w-full p-6 sm:p-7 space-y-5 relative transform transition-all"
    >
        <!-- Close Button -->
        <button 
...
' +
                        ...
                        target="_blank" 
                        class="w-full py-3.5 bg-whatsapp hover:bg-whatsapp-dark text-white rounded-2xl font-bold text-xs shadow-md hover:scale-[1.02] flex items-center justify-center gap-2.5 transition-all duration-300"
                    >
