    ...
    <header class="sticky top-0 z-50 bg-white/98 backdrop-blur-md border-b border-gray-100 shadow-2xs">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div x-show="mobileMenuOpen" x-cloak class="md:hidden py-3 border-t border-gray-100 space-y-1">
                ...
                <a href="{{ route('products.index') }}" class="block px-3 py-2 rounded-md text-xs font-semibold {{ request()->routeIs('products.*') ? 'text-[#A33B47] bg-[#FBEFE9]' : 'text-gray-800' }}">Catalog</a>
                <button type="button" @click="mobileMenuOpen = false; $store.cart.isOpen = true" class="w-full text-left px-3 py-2 rounded-md text-xs font-semibold text-gray-800 flex items-center justify-between">
